...
extern u8 KAERMAN_FLAG,PS2_FLAG,POSITION_FLAG,ATTITUDE_FLAG,IMU_FLAG,SAFE_FLAG,DAYIN_FLAG,LAND_FLAG,AADC_FLAG;
...
extern DroneTargetInfo Target_Info;           //飞行器目标的全局变量
extern Data_Combine DataCombineflag;      	  //
extern DroneFlightControl FlightControl;      //飞行器状态变量
extern Thrust UAVThrust;					  //飞行器扭力计算
extern DroneErrangle Errangle_Info;           //飞行器平地校准数据
extern OffsetInfo OffsetData;                 //磁校准数据全局变量
extern Throttle Throttle_Info;								 //电调油门百分比
